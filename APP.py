...
if tipo_animal == "Gato":
    ...
    with col1:
        st.image("gato_normal.png", caption="Estado normal (Todo en conjunto: Orejas arriba, boca cerrada, ojos abiertos, Bigotes relajados)")
    with col2:
        st.image("gato_dolor.png", caption="Estado con dolor (Todo en conjunto: Ojos cerrados, orejas caídas, boca abierta, Bigotes erizados)")
